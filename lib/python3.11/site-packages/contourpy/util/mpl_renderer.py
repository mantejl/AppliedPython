...
class MplRenderer(Renderer):
    ...
    """Utility renderer using Matplotlib to render a grid of static over the same (x, y) range.

    Args:
        nrows (int, optional): Number of rows of static, default ``1``.
        ncols (int, optional): Number of columns of static, default ``1``.
    ...
    def grid(
        ...
        Warning:
            ``quad_as_tri_alpha > 0`` static all quads as though they are unmasked.
        """
        ax = self._get_ax(ax)
    ...
    def save(self, filename: str, transparent: bool = False) -> None:
        """Save static to SVG or PNG file.
    ...
    def save_to_buffer(self) -> io.BytesIO:
        """Save static to an ``io.BytesIO`` buffer.
    ...
    def show(self) -> None:
        """Show static in an interactive window, in the usual Matplotlib manner.
        """
        self._autoscale()
        plt.show()
...
class MplTestRenderer(MplRenderer):
    ...
    No whitespace around static and no spines/ticks displayed.
